    ...
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl p-6 w-full max-w-md shadow-2xl border border-rose-100 space-y-4 animate-in fade-in zoom-in duration-200">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-2.5 px-4 bg-white border border-gray-300 hover:border-gray-400 text-gray-700 font-bold rounded-2xl text-xs shadow-xs flex items-center justify-center space-x-2.5 transition active:scale-98 disabled:opacity-50"
        >
        ...
        <div className="relative flex py-1 items-center">
          ...
          <span className="flex-shrink mx-3 text-[10px] text-gray-400 font-semibold uppercase">Atau E-mel</span>
          <div className="flex-grow border-t border-gray-200"></div>
        </div>
